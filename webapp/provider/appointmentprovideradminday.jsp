...
function storeApptNo(apptNo) {
	...
	new Ajax.Request(url, {method:'get'}); b
}
...
function confirmPopupPage(height, width, queryString, doConfirm, allowDay, allowWeek){
        if (doConfirm == "Yes") {
                ...
                if (allowWeek == "No") {
                        ...
                        popupPage3(queryString, 'appointment', height, width);
                }
        }
        else {
                popupPage3(queryString, 'appointment', height, width);
...
function popupPage3(varpage, windowname, vheight, vwidth) {
// Provide default values for windowname, vheight, and vwidth incase popupPage2
// is called with only 1 or 2 arguments (must always specify varpage)
windowname  = typeof(windowname)!= 'undefined' ? windowname : 'apptProviderSearch';
vheight     = typeof(vheight)   != 'undefined' ? vheight : '700px';
...
<a class="add" onclick="" style="cursor:pointer;"><u>A</u>dd</a>
...
<div id="backpop" style="width:100%;display:none;height:100%;z-index:400;top:0;position:absolute;">
<div id="popup" style="display: none;position: fixed;z-index: 500;top: 100px;height: 500px;width: 40%;background: white none repeat scroll 0% 0%;border: 1px solid black;margin-left: 30%;border-radius: 5px;box-shadow: 0px 0px 20px 1px black;">
	<input type="image" class="close" style="float:right;width: 25px;height: 25px;margin: 5px;"  src="<c:out value="../oscarEncounter/graphics/close.png"/>" title='<bean:message key="global.btnExit"/>'>
