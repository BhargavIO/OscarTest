 ...
 function displayIssue(id) {
   ...
   function removeIssue(id) {
    ...
    function writeToEncounterNote(request) {
        ...
        if( $(caseNote).value.length > 0 && $(caseNote).value.trim().slice(1)=="[" && $(caseNote).value.trim().slice(-1)=="]")
            $(caseNote).value += "\n\n";
...
function changeToView(id) {
    ...
    if( !saving ) {
       ...
       // }
        ...
        var editAnchor = "<a title='Edit' id='edit"+ nId + "' href='#' onclick='" + func + " return false;' style='float: right; margin-right: 5px; font-size:14px;'>" + editLabel + "</a>";
        var editAnchor = "<a title='Edit' id='edit"+ nId + "' href='#' onclick='" + func + " return false;' style='float: right; margin-right: 5px; font-size:14px;'>" + editLabel + "</a>";
        var editId = "edit" + nId;
...
function newNote(e) {
    ...
    var div = "<div id='" + id + "' class='newNote'><input type='hidden' id='signed" + newNoteIdx + "' value='false'><input type='hidden' id='editWarn" + newNoteIdx + "' value='false'><div id='n" + newNoteIdx + "'><input type='hidden' id='full" + newNoteIdx + "' value='true'>" +
              "<input type='hidden' id='bgColour" + newNoteIdx + "' value='color:#000000;background-color:#000000;'>" + input + "<div class='sig' style='display:inline;' id='" + sigId + "'><\/div>" + passwd + "<\/div><\/div><br \/>&nbsp;<br \/>&nbsp;<br \/>&nbsp;<br \/>";
