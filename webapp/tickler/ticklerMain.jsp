                                        ...
                                        if (linkList != null){
                                            for(TicklerLink tl : linkList){
                                                ...
                                                <% }else if (LabResultData.isHRM(type)){ %>
                                                    <a href="javascript:reportWindow('../hospitalReportManager/Display.do?id=<%=tl.getTableId()%>&segmentID=<%=tl.getTableId()%>&providerNo=<%=user_no%>&searchProviderNo=<%=user_no%>&status=&demoName=<%=demo.getDisplayName()%>')">ATT</a>
                                                <% }else {%>
