...
<h3 style="padding:0px; /*<%=getBackgroundColor(dao)%>*/ background-color:white;color:black;"><a href="javascript:void(0);"
...
<h3 style='text-align: center;background-color:none;'><%=dao.getMenuHeader()%></h3>
<%
...
<%
        	...
        	if(!rh.equals("")) {
             ...
             <div id='menuTitle<%=rh%>' style="width: 10%; float: right; text-align: center;">
      			<h3 style="/*padding:0px; */ background-color:white !important; color:black; /* <%=getBackgroundColor(dao)%>*/">&nbsp;</h3>
      	   </div>
             <%
        } }
...
<h3 style="width:100%; background-color:white; color:black;/*<%=getBackgroundColor(dao)%>*/"><a href="#"
...
<%!
    ...
    public int display(ArrayList<NavBarDisplayDAO.Item>items, int numToDisplay, int numDisplayed, String reloadUrl, boolean xpanded, int numItems, StringBuffer js, int displayThreshold, javax.servlet.http.HttpServletRequest request, javax.servlet.jsp.JspWriter out ) throws IOException {
        ...
        for(j = 0 ; j< total; ++j ) {
                ...
                if ( (j % 2) == 0){
                   stripe = "style=\"overflow: hidden; clear:both; padding: 5px 0 5px 0; padding-left:20px;position:relative; display:block; white-space:nowrap; /*" + bgColour + "*/ \"";
                   dateColour = bgColour;
                }else{
                   stripe = "style=\"overflow: hidden; clear:both; position:relative; display:block;padding: 5px 0 5px 0; padding-left:20px; white-space:nowrap; \"";
                }
