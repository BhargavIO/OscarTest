...
<li id="search">
       ...
       <a HREF="#" ONCLICK ="popupPage2('../demographic/search.jsp');return false;"  TITLE='search' OnMouseOver="window.status='Search' ; return true"><bean:message key="provider.appointmentProviderAdminDay.search"/></a>
...
<ul class="right">
<li class="logout">
      <a href="../logout.jsp" style="color:white;"><bean:message key="global.btnLogout"/></a>
  </li>
</ul>	
