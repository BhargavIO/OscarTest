...
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/mainheader.css" type="text/css" />
  ...
  <% } %>
   ...
   function addCppRow(rowNumber) {
		if(!document.getElementById("divR" + rowNumber)) {
			...
			var i1 = makeElement('div',{'id':'divR' + rowNumber + 'I1','class':'topBox','style':'clear: left; float: left; width: 10%; margin-left: 3px;height: inherit;'});
			var i2 = makeElement('div',{'id':'divR' + rowNumber + 'I2','class':'topBox','style':'clear: right; float: right; width: 10%; margin-right: 3px;height: inherit;'});
...
<!--[if IE]>
 ...
 <![endif]-->
    ...
    <script type="text/javascript">
        ...
        pastO7bservationDateError = "<bean:message key="oscarEncounter.pastObservationDateError.msg"/>";
...
function doscroll(){			
  ...
  <body id="body" style="margin:0px;padding-top:30px;" onunload="onClosing()">
...
<%@include file="../mainheader.jsp"%>
	...
	<div style="float:left;    width: 20%; height: 800px; overflow: auto;">
          ...
          <div id="content" style="width:80%;float:right;background-color:#ffffff;">
              <tiles:insert attribute="body" />
          </div>

          <!-- hovering divs -->
          <div id="showEditNote" class="showEdContent" style="background-color:white;font-size:14px;top:50px !important;padding-left:10px !important;padding-right:10px !important;border-radius:10px;position:fixed;border:0 none;width:40%;left:30%;box-shadow:0px 0px 50px 1px black;">
              <form id="frmIssueNotes" action="" method="post" onsubmit="return updateCPPNote();" sytle="padding:10px;">
		  ...
		  <input type="hidden" id="annotation_attrib" name="annotation_attrib">
                  <div id="winTitle"></div><input type="image" style="float:right;" src="<c:out value="${ctx}/oscarEncounter/graphics/close.png"/>" title='<bean:message key="global.btnExit"/>' onclick="this.focus();$('channel').style.visibility ='visible';$('showEditNote').style.display='none';return false;">
                  <textarea style="margin:10px;" cols="50" rows="10" id="noteEditTxt" name="value" ></textarea><br>
                  <div>
		  <table>
			...
			<td><input type="text" id="startdate" name="startdate" value="" size="12" placeholder="YYYY-MM-DD">  </td></tr>
		      <tr id="Itemresolutiondate"><td><bean:message key="oscarEncounter.resolutionDate.title"/>: </td>
			<td><input type="text" id="resolutiondate" name="resolutiondate" value="" size="12" placeholder="YYYY-MM-DD"></td></tr>
			...
			<td><input type="text" id="proceduredate" name="proceduredate" value="" size="12" placeholder="YYYY-MM-DD"> </td></tr>
			...
			<tr id="Itemlifestage"><td><bean:message key="oscarEncounter.lifestage.title"/>: </td>
			 ...
			 <tr><td><bean:message key="oscarEncounter.Index.btnPosition"/>:</td><td><select id="position" name="position" ><option id="popt0" value="0">1</option>
                  </select></td></tr>	
		  </table>
		  <span class="utilitiesHead" id="utilitiesHead"    style=" padding: 5px;    float: right;    color: black;    box-shadow: 0px 0px 1px 1px rgba(0,0,0,.2);cursor:pointer;    border: 1px solid black;" onmouseover="$('utilities').style.display='block';" onmouseout="$('utilities').style.display='none';">Utilities
                  <span class="utilities" id="utilities" style="float:right; background: rgba(0, 0, 0, 0.34) none repeat scroll 0% 0%;margin: 10px;padding: 10px; display:none;z-index:301;" >
                  <table><tr>
					  <td><input type="image" src="<c:out value="${ctx}/oscarEncounter/graphics/cp.png"/>" title='<bean:message key="oscarEncounter.Index.btnCopy"/>' onclick="copyCppToCurrentNote(); return false;"></td>
			      	  <td><input type="image" src="<c:out value="${ctx}/oscarEncounter/graphics/annot.png"/>" title='<bean:message key="oscarEncounter.Index.btnAnnotation"/>' id="anno" style=""></td></tr>
                      <tr><td><input type="image" src="<c:out value="${ctx}/oscarEncounter/graphics/archive.png"/>" title='<bean:message key="oscarEncounter.Index.btnArchive"/>' onclick="$('archived').value='true';" style=""></td>
                      <td><input type="image" src="<c:out value="${ctx}/oscarEncounter/graphics/save.png"/>" title='<bean:message key="oscarEncounter.Index.btnSignSave"/>' onclick="$('archived').value='false';" style=""></td>
                      </tr>
                  </table> 
                  </span>
                  </span>
